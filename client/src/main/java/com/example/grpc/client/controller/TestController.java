...
public class TestController {
	...
	@GetMapping("/testapp")
	public String testApp() throws InterruptedException {
		try {
			logger.info("Execute test app endpoint ....");
			MessageRequest messageRequest = MessageRequest.newBuilder()
				.setMessage("test app with jwt authentication")
				.build();

			MessageResponse messageResponse = stub.testApp(messageRequest);
